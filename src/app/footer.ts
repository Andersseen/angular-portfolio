...
@Component({
  ...
  template: `
    <section class="border-border border-foreground/50 border-t pt-12 pb-24">
          ...
          <div class="grid gap-8 md:grid-cols-3">
            ...
            <div class="flex flex-col gap-4 md:col-span-2">
              ...
              <div class="flex gap-3">
                @for (social of portfolioService.socialLinks; track $index) {
                  <a
                    [href]="social.url"
                    target="_blank"
                    rel="noopener noreferrer"
                    class="bg-muted text-muted-foreground hover:bg-primary hover:text-primary-foreground flex h-10 w-10 items-center justify-center rounded-full transition-colors"
            ...
            <div class="flex flex-col gap-4">
              <h4 class="text-foreground text-lg font-semibold">
                {{ getContent()?.footer.contactTitle }}
              </h4>
