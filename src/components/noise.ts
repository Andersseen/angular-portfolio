...
@Component({
  ...
  template: `
    <div class="relative h-full w-full" #OmNoiseWrapper>
      <canvas #OmNoiseCanvas class="noise-overlay"></canvas>
    </div>
  `,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export default class Noise implements AfterViewInit, OnDestroy {
